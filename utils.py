...
TRANSLATIONS = {
    'English': {
        ...
        'simulated_warn': '⚠️ Using Simulated Data (Demo Mode)',
        'model_based_reason': 'Based on the pattern in your uploaded prediction model.',
        ...
        'tip_content': 'Drip irrigation can save up to 50% water while increasing yield by 30%.',
        'scheme_content': 'PM-Kisan: Eligible farmers get ₹6,000 per year in 3 installments.',
        'market_content': 'Soybean prices are seeing an upward trend in your region.',
        # Extra Section
        'trending_videos': '📺 Trending Farming Videos',
        'community_poll': '📊 Farmer Poll',
        'poll_q': 'What is your biggest challenge currently?',
        'poll_opt1': 'Water Scarcity',
        'poll_opt2': 'Pest Attack',
        'poll_opt3': 'Low Market Price',
        'vote_now': 'Vote Now',
        'watch_now': 'Watch',
    ...
    'Hindi': {
        ...
        'model_based_reason': 'आपके अपलोड किए गए भविष्यवाणी मॉडल पैटर्न पर आधारित।',
        ...
        'simulated_warn': '⚠️ सिम्युलेटेड डेटा (डेमो मोड)',
        ...
        'market_alert': 'बाजार अपडेट',
        'tip_content': 'ड्रिप सिंचाई से 50% तक पानी की बचत हो सकती है और पैदावार 30% बढ़ सकती है।',
        'scheme_content': 'पीएम-किसान: पात्र किसानों को 3 किस्तों में प्रति वर्ष ₹6,000 मिलते हैं।',
        'market_content': 'आपके क्षेत्र में सोयाबीन की कीमतों में वृद्धि देखी जा रही है।',
        # Extra Section
        'trending_videos': '📺 ट्रेंडिंग खेती वीडियो',
        'community_poll': '📊 किसान पोल (राय)',
        'poll_q': 'वर्तमान में आपकी सबसे बड़ी चुनौती क्या है?',
        'poll_opt1': 'पानी की कमी',
        'poll_opt2': 'कीटों का हमला',
        'poll_opt3': 'कम बाजार भाव',
        'vote_now': 'वोट दें',
        'watch_now': 'देखें',
    ...
    'Marathi': {
        ...
        'model_based_reason': 'तुमच्या अपलोड केलेल्या अंदाज मॉडेल पॅटर्नवर आधारित.',
        ...
        'simulated_warn': '⚠️ सिम्युलेटेड डेटा वापरत आहे (डेमो मोड)',
        ...
        'kb_contact': 'संपर्क',
        # Daily Wisdom
        'daily_wisdom': '💡 दैनिक सुविचार',
        'tip_of_day': 'आजचा सल्ला',
        'did_you_know': 'तुम्हाला माहित आहे का?',
        'govt_scheme': 'सरकारी योजना',
        'market_alert': 'बाजार अपडेट',
        'tip_content': 'ठिबक सिंचनामुळे 50% पर्यंत पाण्याची बचत होऊ शकते आणि उत्पादन 30% वाढू शकते.',
        'scheme_content': 'पीएम-किसान: पात्र शेतकऱ्यांना वर्षाला 3 हप्त्यांमध्ये ₹6,000 मिळतात.',
        'market_content': 'तुमच्या भागात सोयाबीनच्या भावात वाढ होत आहे.',
        # Extra Section
        'trending_videos': '📺 ट्रेंडिंग शेती व्हिडिओ',
        'community_poll': '📊 शेतकरी पोल (मत)',
        'poll_q': 'सध्या तुमची सर्वात मोठी समस्या कोणती?',
        'poll_opt1': 'पाण्याची कमतरता',
        'poll_opt2': 'कीटकांचा हल्ला',
        'poll_opt3': 'कमी बाजार भाव',
        'vote_now': 'मत द्या',
        'watch_now': 'पहा',
...
# --- SESSION INITIALIZATION (INTERNAL) ---
def _ensure_session():
    import streamlit as st
    import os
    import json
...
def t(key):
    ...
    # Auto-initialize session on first translation call
    if 'language' not in st.session_state:
        _ensure_session()
...
# --- DAILY WISDOM CONTENT ROTATOR ---
def get_daily_wisdom(lang='English'):
    from datetime import datetime
    
    # 3 Sets of Content
    content_pool = [
        {
            # Set 0 (Water/Soybean/PM-Kisan)
            'tip': {
                'English': 'Drip irrigation can save up to 50% water while increasing yield by 30%.',
                'Hindi': 'ड्रिप सिंचाई से 50% तक पानी की बचत हो सकती है और पैदावार 30% बढ़ सकती है।',
                'Marathi': 'ठिबक सिंचनामुळे 50% पर्यंत पाण्याची बचत होऊ शकते आणि उत्पादन 30% वाढू शकते.'
            },
            'market': {
                'English': 'Soybean prices are seeing an upward trend in your region.',
                'Hindi': 'आपके क्षेत्र में सोयाबीन की कीमतों में वृद्धि देखी जा रही है।',
                'Marathi': 'तुमच्या भागात सोयाबीनच्या भावात वाढ होत आहे.'
            },
            'scheme': {
                'English': 'PM-Kisan: Eligible farmers get ₹6,000 per year in 3 installments.',
                'Hindi': 'पीएम-किसान: पात्र किसानों को 3 किस्तों में प्रति वर्ष ₹6,000 मिलते हैं।',
                'Marathi': 'पीएम-किसान: पात्र शेतकऱ्यांना वर्षाला 3 हप्त्यांमध्ये ₹6,000 मिळतात.'
            }
        },
        {
            # Set 1 (Crop Rotation/Cotton/Soil Health)
            'tip': {
                'English': 'Crop rotation maintains soil fertility and controls pests naturally.',
                'Hindi': 'फसल चक्रण मिट्टी की उर्वरता बनाए रखता है और प्राकृतिक रूप से कीटों को नियंत्रित करता है।',
                'Marathi': 'पीक फेरपालट जमिनीची सुपीकता टिकवून ठेवते आणि कीड नियंत्रित करते.'
            },
            'market': {
                'English': 'Cotton prices are currently stable. Good time to hold stock.',
                'Hindi': 'कपास के भाव फिलहाल स्थिर हैं। स्टॉक रखने का अच्छा समय है।',
                'Marathi': 'कापसाचे भाव सध्या स्थिर आहेत. साठा करण्यासाठी चांगली वेळ आहे.'
            },
            'scheme': {
                'English': 'Soil Health Card: Get free soil testing every 2 years.',
                'Hindi': 'मृदा स्वास्थ्य कार्ड: हर 2 साल में मुफ्त मिट्टी की जांच कराएं।',
                'Marathi': 'मृदा आरोग्य पत्रिका: दर 2 वर्षांनी मोफत माती परीक्षण करून घ्या.'
            }
        },
        {
            # Set 2 (Mulching/Onion/PMFBY)
            'tip': {
                'English': 'Mulching prevents moisture loss and weeds. Saves irrigation costs.',
                'Hindi': 'मल्चिंग नमी की कमी और खरपतवार को रोकता है। सिंचाई की लागत बचाता है।',
                'Marathi': 'मल्चिंगमुळे ओलावा टिकून राहतो आणि तण वाढत नाही. सिंचनाचा खर्च वाचतो.'
            },
            'market': {
                'English': 'Onion supply is high, expecting a slight price drop.',
                'Hindi': 'प्याज की आवक ज्यादा है, भाव में थोड़ी गिरावट की संभावना है।',
                'Marathi': 'कांद्याची आवक जास्त आहे, भावात थोडी घट होण्याची शक्यता आहे.'
            },
            'scheme': {
                'English': 'PMFBY: Insure your crops against non-preventable natural risks.',
                'Hindi': 'PMFBY: प्राकृतिक आपदाओं से होने वाले नुकसान के लिए फसल का बीमा कराएं।',
                'Marathi': 'PMFBY: नैसर्गिक आपत्तींमुळे होणाऱ्या नुकसानीसाठी पिकाचा विमा काढा.'
            }
        },
        {
            # Set 3 (Organic/Wheat/KCC)
            'tip': {
                'English': 'Using Neem cake reduces soil pests and improves nitrogen efficiency.',
                'Hindi': 'नीम की खली का उपयोग मिट्टी के कीटों को कम करता है और नाइट्रोजन दक्षता बढ़ाता है।',
                'Marathi': 'लिंबोळी पेंड वापरल्याने जमिनीतील कीड कमी होते आणि नायट्रोजनची कार्यक्षमता वाढते.'
            },
            'market': {
                'English': 'Wheat procurement prices have been hiked by the government.',
                'Hindi': 'सरकार ने गेहूं के खरीद मूल्य में बढ़ोतरी की है।',
                'Marathi': 'सरकारने गव्हाच्या खरेदी भावात वाढ केली आहे.'
            },
            'scheme': {
                'English': 'Kisan Credit Card (KCC): Low interest loans for farming needs.',
                'Hindi': 'किसान क्रेडिट कार्ड (KCC): खेती की जरूरतों के लिए कम ब्याज पर ऋण।',
                'Marathi': 'किसान क्रेडिट कार्ड (KCC): शेतीसाठी कमी व्याजावर कर्ज.'
            }
        },
        {
            # Set 4 (Seeds/Tomato/e-NAM)
            'tip': {
                'English': 'Treat seeds with Trichoderma before sowing to prevent root diseases.',
                'Hindi': 'जड़ के रोगों को रोकने के लिए बुवाई से पहले बीजों को ट्राइकोडर्मा से उपचारित करें।',
                'Marathi': 'मूळकूज रोग टाळण्यासाठी पेरणीपूर्वी बियाण्यांवर ट्रायकोडर्माची प्रक्रिया करा.'
            },
            'market': {
                'English': 'Tomato prices are fluctuating due to recent rains.',
                'Hindi': 'हाल ही में हुई बारिश के कारण टमाटर के भाव में उतार-चढ़ाव हो रहा है।',
                'Marathi': 'नुकत्याच झालेल्या पावसामुळे टोमॅटोच्या भावात चढ-उतार होत आहे.'
            },
            'scheme': {
                'English': 'e-NAM: Sell your produce online to get better prices nationally.',
                'Hindi': 'e-NAM: राष्ट्रीय स्तर पर बेहतर कीमत पाने के लिए अपनी उपज ऑनलाइन बेचें।',
                'Marathi': 'e-NAM: राष्ट्रीय स्तरावर चांगला भाव मिळवण्यासाठी तुमचा शेतमाल ऑनलाइन विका.'
            }
        },
        {
            # Set 5 (Vermicompost/Maize/Kusum)
            'tip': {
                'English': 'Vermicompost improves soil structure and water holding capacity.',
                'Hindi': 'वर्मीकम्पोस्ट मिट्टी की संरचना और जल धारण क्षमता में सुधार करता है।',
                'Marathi': 'गांडूळ खतामुळे जमिनीचा पोत सुधारतो आणि पाणी धरून ठेवण्याची क्षमता वाढते.'
            },
            'market': {
                'English': 'Maize demand from poultry sector is increasing market rates.',
                'Hindi': 'पोल्ट्री क्षेत्र से मक्का की मांग बढ़ने से बाजार भाव बढ़ रहे हैं।',
                'Marathi': 'पोल्ट्री क्षेत्राकडून मक्याची मागणी वाढल्याने बाजारभाव वाढत आहेत.'
            },
            'scheme': {
                'English': 'PM-KUSUM: Get subsidy for installing solar pumps on your farm.',
                'Hindi': 'PM-KUSUM: अपने खेत में सोलर पंप लगाने के लिए सब्सिडी प्राप्त करें।',
                'Marathi': 'PM-KUSUM: तुमच्या शेतात सोलर पंप बसवण्यासाठी सबसिडी मिळवा.'
            }
        },
        {
            # Set 6 (Pruning/Turmeric/MIDH)
            'tip': {
                'English': 'Timely pruning of fruit trees ensures better sunlight and higher quality fruits.',
                'Hindi': 'फलदार पेड़ों की समय पर छंटाई से बेहतर धूप और उच्च गुणवत्ता वाले फल सुनिश्चित होते हैं।',
                'Marathi': 'फळझाडांची वेळेवर छाटणी केल्यास सूर्यप्रकाश चांगला मिळतो आणि फळांची गुणवत्ता सुधारते.'
            },
            'market': {
                'English': 'Turmeric exports are rising, keeping domestic prices strong.',
                'Hindi': 'हल्दी का निर्यात बढ़ रहा है, जिससे घरेलू कीमतें मजबूत बनी हुई हैं।',
                'Marathi': 'हळदीची निर्यात वाढत असल्याने देशांतर्गत बाजारभाव तेजीत आहेत.'
            },
            'scheme': {
                'English': 'MIDH: Assistance for horticulture crops, greenhouses, and cold storage.',
                'Hindi': 'MIDH: बागवानी फसलों, ग्रीनहाउस और कोल्ड स्टोरेज के लिए सहायता।',
                'Marathi': 'MIDH: फळबाग, ग्रीनहाऊस आणि कोल्ड स्टोरेजसाठी सरकारी मदत.'
            }
        }
    ]
    
    # Pick based on day of month (mod 7) for weekly rotation
    day_idx = datetime.now().day % 7
    
    # Fallback to English if lang key missing (unlikely hardcoded)
    selected_set = content_pool[day_idx]
    
    return {
        'tip': selected_set['tip'].get(lang, selected_set['tip']['English']),
        'market': selected_set['market'].get(lang, selected_set['market']['English']),
        'scheme': selected_set['scheme'].get(lang, selected_set['scheme']['English'])
    }
